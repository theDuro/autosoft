...
const MachineErrors = ({ machineId }) => {
  ...
  const [showNiverplast, setShowNiverplast] = useState(false);

  const [partsPositions] = useState([
    // ==== WILK 1–37 ====
    { partId: 1,  machine: "WILK",       x: 93, y: 70, name: "Part 1"  },
    { partId: 2,  machine: "WILK",       x: 90, y: 50, name: "Part 2"  },
    { partId: 3,  machine: "WILK",       x: 85, y: 43, name: "Part 3"  },
    { partId: 4,  machine: "WILK",       x: 83, y: 38, name: "Part 4"  },
    { partId: 5,  machine: "WILK",       x: 84, y: 34, name: "Part 5"  },
    { partId: 6,  machine: "WILK",       x: 80, y: 25, name: "Part 6"  },
    { partId: 7,  machine: "WILK",       x: 70, y: 25, name: "Part 7"  },
    { partId: 8,  machine: "WILK",       x: 66, y: 20, name: "Part 8"  },
    { partId: 9,  machine: "WILK",       x: 56, y: 20, name: "Part 9"  },
    { partId: 10, machine: "WILK",       x: 50, y: 20, name: "Part 10" },
    { partId: 11, machine: "WILK",       x: 41, y: 20, name: "Part 11" },
    { partId: 12, machine: "WILK",       x: 30, y: 20, name: "Part 12" },
    { partId: 13, machine: "WILK",       x: 17, y: 26, name: "Part 13" },
    ...
    { partId: 21, machine: "WILK",       x: 10, y: 55, name: "Part 21" },
    { partId: 22, machine: "WILK",       x: 20, y: 55, name: "Part 22" },
    { partId: 23, machine: "WILK",       x: 30, y: 55, name: "Part 23" },
    { partId: 24, machine: "WILK",       x: 10, y: 67, name: "Part 24" },
    { partId: 25, machine: "WILK",       x: 20, y: 67, name: "Part 25" },
    ...
    { partId: 33, machine: "WILK",       x: 64, y: 45, name: "Part 33" },
    { partId: 34, machine: "WILK",       x: 50, y: 33, name: "Part 34" },
    { partId: 35, machine: "WILK",       x: 60, y: 33, name: "Part 35" },
    { partId: 36, machine: "WILK",       x: 50, y: 26, name: "Part 36" },
    { partId: 37, machine: "WILK",       x: 58, y: 26, name: "Part 37" },
    // ==== NIVERPLAST 38–42 ====
    { partId: 38, machine: "NIVERPLAST", x: 30, y: 50, name: "Part 38" },
    { partId: 39, machine: "NIVERPLAST", x: 45, y: 50, name: "Part 39" },
    { partId: 40, machine: "NIVERPLAST", x: 52, y: 93, name: "Part 40" },
    { partId: 41, machine: "NIVERPLAST", x: 40, y: 90, name: "Part 41" },
    { partId: 42, machine: "NIVERPLAST", x: 35, y: 10, name: "Part 42" },
  ]);
      ...
      <div style={{ position: "relative", width: "100%", height: "calc(100% - 80px)" }}>
        {["WILK", "NIVERPLAST"].map(machine => (
          <div
            ...
            style={{
              position: "absolute",
              left: machine === "WILK" ? 0 : "60%",
              width: machine === "WILK" ? "60%" : "40%",
              height: "100%",
              background: `url(${machine === "WILK" ? WILK2 : Niverplast}) center/contain no-repeat`,
            }}
          >
            {partsPositions.filter(p => p.machine === machine).map(p => {
